...
describe('MembersTable - Initial Rendering', () => {
  ...
  it('should render all column headers', () => {
    ...
    expect(screen.queryByRole('columnheader', { name: 'Taxes' })).not.toBeInTheDocument();
    expect(screen.queryByRole('columnheader', { name: 'Profit Share' })).not.toBeInTheDocument();
    expect(screen.queryByRole('columnheader', { name: 'Net After Fees' })).not.toBeInTheDocument();
  });
  ...
  it('should render all member rows', () => {
    ...
    // Members appear in both desktop table and mobile card views
...
describe('MembersTable - User Interactions', () => {
  ...
  it('should pass correct props to MemberRow components', () => {
    ...
    // Verify member data is rendered (appears in both desktop and mobile views)
...
describe('MembersTable - Data Display', () => {
  ...
  it('should render individual expenses for members', () => {
    ...
    // Expense appears in both desktop and mobile views
